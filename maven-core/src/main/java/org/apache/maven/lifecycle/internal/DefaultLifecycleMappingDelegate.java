...
public class DefaultLifecycleMappingDelegate implements LifecycleMappingDelegate {
    ...
    public static Logger logger = LoggerFactory.getILoggerFactory().getLogger("DefaultLifecycleMappingDelegate");
    ...
    public Map<String, List<MojoExecution>> calculateLifecycleMappings(MavenSession session, MavenProject project,
        ...
        logger.info("lifecyclePhase:{},lifecycle:{},result:{}", lifecyclePhase, JSON.toJSONString(lifecycle),
            mappings.keySet());
        /*
         ...
         */
        logger.info("project plugins:{}", JSON.toJSONString(project.getBuild().getPlugins()));
