...
public class DefaultLifecycles {
    ...
    public DefaultLifecycles(Map<String, Lifecycle> lifecycles, Logger logger) {
        ...
        this.logger = logger;
        logger.info("lifecycles:" + JSON.toJSONString(lifecycles));
    ...
    public Map<String, Lifecycle> getPhaseToLifecycleMap() {
        ...
        logger.info("phaseToLifecycleMap:" + JSON.toJSONString(phaseToLifecycleMap));
    ...
    public List<Lifecycle> getLifeCycles() {
        ...
        logger.info("getLifeCycles:" + JSON.toJSONString(result));
        return result;
    }
